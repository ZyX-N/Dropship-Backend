...
import { approvedVendorBecomePartner } from '../controllers/admin/approvedController.js';
import { deleteProductReview, getProductReviews, updateProductReview } from '../controllers/admin/reviewsController.js';
...
adminAuthRoute.group('/vendor-product', (adminAuthRoute) => {
  ...
  adminAuthRoute.put(
    ...
    [
      ...
      body('mrp').optional().isInt({ min: 1 }).withMessage('mrp value should be a positive integer'),
      body('stock')
        .notEmpty()
...
adminAuthRoute.group('/become-a-partner-approval', (adminAuthRoute) => {
  adminAuthRoute.post('/', adminValiation, approvedVendorBecomePartner);
});
